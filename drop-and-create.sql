...
create table customer (id varchar(36) not null, created_date timestamp(6), email varchar(255), first_name varchar(255), last_name varchar(255), phone_number varchar(255), update_date timestamp(6), version integer, primary key (id));
